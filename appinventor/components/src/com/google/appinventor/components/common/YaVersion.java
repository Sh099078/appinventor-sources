...
public class YaVersion {
  ...
  // For QAXH_ETH_COMPONENT_VERSION 1:
  // - Initial implementation 
    public static final int QAXH_ETH_COMPONENT_VERSION = 1;

  // For QAXH_QR_COMPONENT_VERSION 1:
  // - Initial implementation
    public static final int QAXH_QR_COMPONENT_VERSION = 1;

  // For QAXH_TRANS_COMPONENT_VERSION 1:
  // - Initial implementation
    public static final int QAXH_TRANS_COMPONENT_VERSION = 1;

  // For QAXH_SC_COMPONENT_VERSION 1:
  // - Initial implementation
  public static final int QAXH_SC_COMPONENT_VERSION = 1;
